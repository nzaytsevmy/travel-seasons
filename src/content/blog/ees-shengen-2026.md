...
С **10 апреля 2026** на границах Шенгенской зоны заработала система **EES (Entry/Exit System)**. Привычные штампы в паспорте — всё, ушли в прошлое. Вместо них электронная регистрация с биометрией: фото лица и отпечатки пальцев.

Россияне попадают под новые правила в полной мере. При первом въезде после запуска биометрию снимут обязательно. Без неё на границу не пустят — развернут и улетите домой за свой счёт.
