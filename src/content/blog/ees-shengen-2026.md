...
checks:
  ...
  - date: 2026-09-10
    ...
    minor: true
    sources:
      - name: "официальным сайтом ЕЭС"
        url: "https://travel-europe.europa.eu/en/ees"
      - name: "Еврокомиссия (EES official)"
...
В материале — что реально происходит на границе, тайминги и нюансы пересадок.
...
* **Интернет — с посадки, не после багажа.** Очередь на контроле может съесть 1–4 часа, а бесплатный Wi-Fi есть не во всех зонах прилёта.
...
Да. На сухопутных пунктах пропуска EES тоже работает. Финляндия закрыла границу с РФ для туристов с конца 2023 года, но через Эстонию или Латвию проехать можно — проверяйте актуальные требования перед поездкой.
