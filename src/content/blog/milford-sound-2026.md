...
description: "Милфорд-Саунд своими силами: каяк или круиз, когда ехать (почему дождь — плюс), мошка, как добраться из Те-Анау и Квинстауна, виза 311 NZD."
pubDate: 2026-05-17
...
> **Если коротко:** Милфорд-Саунд — фьорд на юго-западе Южного острова. Круиз ~**100–120 NZD** (2 ч, ты зритель), каяк-тур ~**230–260 NZD** (4–5 ч, ты внутри). Дождь — не враг, а **главное шоу**: каждая стена покрывается сотней водопадов. Ехать база — **Те-Анау (2 ч)**, не однодневкой из Квинстауна (4+ ч в один конец). Виза россиянам **211 + 100 NZD**, NZeTA не подходит. Мошка namu — репеллент с DEET обязателен.
...
* Стоимость: **211 NZD** (~11 000 ₽) + International Visitor Levy **100 NZD** (поднялся с 35 до 100 NZD с 1 октября 2024).
