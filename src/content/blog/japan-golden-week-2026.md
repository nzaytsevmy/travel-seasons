...
checks:
  - date: 2026-09-21
    minor: true
    what: "Уточнён план поездки в Никко и добавлена ссылка на маршрут"
    changed: "Уточнён маршрут в Никко и добавлена ссылка на подробный план. Храмовый район отделён от озера и водопада, которым нужен дополнительный день при совместном посещении."
    sources:
      - name: "Официальный путеводитель Никко: дорога и осенние пробки"
        url: "https://visitnikko.jp/en/plan-your-trip/getting-to-and-around-nikko/"
  - date: 2026-09-09
    minor: true
    what: "Добавлена ссылка на разбор цены пакетных туров"
    changed: "Существующий текст не менялся. В раздел о выборе других дат добавлена ссылка на разбор, сколько стоит готовый тур в Японию и когда он выгоднее самостоятельной сборки."
    sources:
  ...
  - date: 2026-09-10
    ...
    minor: true
    sources:
      - name: "JNTO Lodging Statistics за GW 2024"
        url: "https://www.jnto.go.jp/statistics/data/visitor-trends/"
---
...
Сам я ехать на Золотую неделю не советую — и в [главном гайде по Японии](/blog/japan-guide-2026/) ставлю красный флажок на эти даты. Но раз вы здесь — значит либо рассматриваете поездку именно на эти числа, либо случайно купили билеты и теперь не понимаете, во что ввязались. Разберу обе ситуации.

> **Если коротко:** в 2026 году Золотая неделя выпадает на **29 апреля — 6 мая**, это 8 дней подряд. Цены на отели в Токио растут до **×3** от средних, синкансены забиты, многие магазины и музеи закрыты на 1–4 дня. Реальная альтернатива это **середина мая** (после 8 мая) или **июнь до начала цую**. Если билеты уже куплены, стратегия в разделе ниже.

> **Дисклеймер:** на Золотой неделе сам в Японии не был. В Японии бывал в другие сезоны (момидзи, сакура до пика), а на Golden Week ехать осознанно избегал. Все факты — со ссылками.
...
**Средний прайс на отель 4* в Токио в Golden Week превышает обычный апрельский почти в 2.5 раза**. По моим выборкам цен на агрегаторах:
...
**Бронировать отели на Golden Week нужно за 4–6 месяцев минимум.** За 1–2 месяца остаётся только премиум-сегмент или пригороды. За 2 недели не остаётся практически ничего, кроме капсульных отелей по 8000 ¥, которые в обычные дни стоят 3500 ¥. Бронировать удобно через Ostrovok: японские отели в каталоге все, карты МИР принимает, а Booking из РФ не работает. <a href="https://ostrovok.tpk.mx/xtyTcUcY?erid=2VtzqvE1cv3&sub_id=japan_golden_week_2026" class="aff-cta" rel="sponsored">Забронировать отель на Golden Week</a>

### Авиабилеты

Средняя цена туда-обратно Москва — Токио (NRT/HND) с пересадкой (<a href="https://aviasales.tpk.mx/JCSPlC17?erid=2Vtzqxkn4LF&sub_id=japan_golden_week_2026&u=https%3A%2F%2Fwww.aviasales.ru%2Fsearch%2FMOW1509TYO1" class="aff-cta" rel="sponsored">найти билет Москва — Токио</a> — сравнивает все авиакомпании сразу):

- Низкий сезон (январь, февраль): **$500–650** (≈41–54 тыс. ₽)
...
**Фестиваль Hakata Dontaku в Фукуоке (3–4 мая).** Один из крупнейших в стране, **парад с 3 миллионами участников**. Если вылетаете не в Токио — Фукуока более тихий вариант, и там этот фестиваль становится главным событием.
...
**Сакура на Хоккайдо.** К началу мая цветение доходит до Хоккайдо (Sapporo, Hakodate), и это **последний шанс года увидеть сакуру**. Если в основной Японии она к этому времени опала, на севере — пик. Билеты Токио — Sapporo на синкансене дорогие, но летать ANA/JAL быстрее (2 часа вместо 4).

---

![Бамбуковая роща в Арасияме — альтернатива переполненному Киото](./_images/japan-arashiyama-bamboo.jpg)

На пиковых датах пакетный тур выигрывает у самостоятельной сборки: цены и разбор наценки — в [отдельной статье](/blog/tur-v-yaponiyu-2027/).

## Что делать если купили билеты на эти даты
...
- **[Никко](/blog/nikko-iz-tokio-za-odin-den/)** (около 2 часов от Токио) — храмовый маршрут; озеро и водопад оставьте на отдельный день, а вместе с храмами планируйте с ночёвкой.
...
**Сразу после Golden Week — со 2-й недели мая.** Цены падают резко: к 8–10 мая отели возвращаются к обычным апрельским тарифам или даже ниже. Сакура отцвела, но погода стабильно тёплая (+22–25 °C), без сезона дождей. **Лучший компромисс мая** это 10–25 мая: цены на 40% ниже, чем в Золотую неделю, погода +22–25 °C. Сакуры нет, за ней надо ехать в апреле.
...
**Да, 7 мая 2026 — обычный рабочий четверг** в Японии. Золотая неделя заканчивается 6 мая. С 7 мая офисы открыты, отели возвращаются к плановым ценам в течение 2–3 дней (полностью — к 8–10 мая), синкансены свободны без брони, очереди в музеи и парки спадают. 7 мая — первый день, когда отели сбрасывают наценку Золотой недели, а синкансены свободны без брони.
...
**Что если билеты куплены и не вернуть?**

Коротко: уехать из Токио на 5–6 из 8 дней, бронировать рестораны заранее, +50% к бюджету. Подробно — [раздел «Что делать если купили билеты»](#что-делать-если-купили-билеты-на-эти-даты) выше.
...
За **30 дней до даты поездки**, через [SmartEX](https://smart-ex.jp/en/) или в JR-офисе. Раньше нельзя — система не открывает резерв. На 3–5 мая места разлетаются за 1–3 дня после открытия. Бронировать в день открытия, в первые часы.
...
Да, [Tax Free](/blog/japan-guide-2026/#бюджет-в-день) работает как обычно при покупке от 5000 ¥ с предъявлением паспорта. Расходники запечатают в пакет, открывать до вылета нельзя.
