...
checks:
  ...
  - date: 2026-09-10
    ...
    minor: true
    sources:
      - name: "официальные данные ЕС за 2024 год"
  ...
  - date: 2026-09-10
    ...
    sources:
      - name: "Сама статья: правка без новых фактов"
        url: "https://traveltribe.ru/blog/schengen-visa-2026/"
pubDate: 2026-04-30
...
> **Если коротко:** шенген россиянам дают, но **с 7 ноября 2025 года почти всем только однократный**, под даты конкретной поездки. Многократную оставили близким родственникам жителей ЕС и транспортникам; в обоснованных случаях её всё ещё можно получить, доказав необходимость частых поездок. Меньше всего отказов у Франции, Италии, Греции и Испании, больше всего у Мальты, Австрии и Эстонии. Под ключ выходит около **150–170 €**, решение принимают за 15 дней, в сложных случаях до 45. Общий отказ россиянам снизился до **6,4%**. Без покрытия от 30 000 € документы на визу не примут — <a href="https://cherehapa.tpk.mx/fkM7suze?erid=2VtzquZTwb5&sub_id=schengen_visa_2026_tldr&u=https%3A%2F%2Fcherehapa.ru%2Ftravel%2F" class="aff-cta" rel="sponsored">подобрать полис для шенгенской визы</a>.
...
* **Стоимость:** 90 € консульский сбор + сервисный сбор визового центра, который по визовому кодексу не превышает половины консульского, то есть 45 €, + страховка от 20 € = около **150–170 €** под ключ.
...
| **Эстония** | 22.6% | Туристические визы россиянам ограничены. |
...
**Под ключ без посредников — около 140–175 € (≈14 000–17 500 ₽) с человека.** Сюда входят фиксированный консульский сбор 90 €, сервисный сбор визового центра 25–55 €, страховка 20–30 € и при необходимости перевод документов. С посредником добавляется их комиссия.
...
Перед подачей проверяйте адреса на [vfsglobal.com/ru](https://www.vfsglobal.com/). Запись только онлайн.
...
Швейцария лояльна (~6% отказов), но дороже: 90 € консульский сбор + ~39 € сервисный TLS + страховка ~30 € + переводы ~20–40 € — суммарно около 180–200 € вместо 150–170 €. Имеет смысл, если едете именно в Швейцарию, в прошлом были там или в других странах часто отказывают.
...
*Консульский сбор — **90 €** для взрослых и 45 € для детей 6–12 лет, размер не менялся с июня 2024. Сервисные сборы визовых центров (25–55 €) сверяйте на сайте центра своей страны перед подачей. Запрет мультивиз — постановление Еврокомиссии от 7.11.2025.*
