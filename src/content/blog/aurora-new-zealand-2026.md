...
Из сайтов: `swpc.noaa.gov/products/aurora-30-minute-forecast` (карта аврорального овала на 30 минут вперёд) и `metservice.com` для прогноза облачности по НЗ. Без чистого неба никакой Kp 9 не поможет.
