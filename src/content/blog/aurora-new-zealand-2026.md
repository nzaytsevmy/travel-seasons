...
description: "Южное сияние в Новой Зеландии — где смотреть (4 точки), когда лететь (апрель–сентябрь), Kp-индекс, виза 311 NZD, бюджет $3200–6000."
pubDate: 2026-05-01
...
> **Если коротко:** южное сияние в НЗ — это **розовая дуга**, не зелёные шторы. Ловится **апрель–сентябрь** на Южном острове (Текапо, Маунт-Кук, Стюарт). Виза **211 NZD**, перелёт через Дубай **1700–2400 USD**, бюджет 7 дней — **3200–6000 USD на человека**. Окно солнечного цикла закрывается к 2027–2028.
...
* Стоимость: **211 NZD** (~11 000 ₽) + International Visitor Levy (IVL) **100 NZD** (поднялся с 35 до 100 NZD с 1 октября 2024 — [immigration.govt.nz](https://www.immigration.govt.nz/about-us/research-and-statistics/research-reports/international-visitor-conservation-and-tourism-levy)).
