...
import { RELATED_POSTS } from './related-posts.js';
...
const SLUG_OVERRIDES = {
  ...
  'Саудовская Аравия|Эль-Ула, Джидда, Красное море': 'saudi-arabia',
  'Оман|Маскат, Салала, вади': 'oman',
  'Катар|Доха': 'qatar',
...
const COUNTRY_CASES = {
  ...
  'australia-north': { nom: 'Северная Австралия', acc: 'Северную Австралию', prep: 'Северной Австралии', vP: 'на север Австралии' , loc: 'на севере Австралии' },
  'bali': { nom: 'Бали', acc: 'Бали', prep: 'Бали', vP: 'на Бали' , loc: 'на Бали' },
  'sumatra-kalimantan': { nom: 'Суматра и Калимантан', acc: 'Суматру и Калимантан', prep: 'Суматре и Калимантане', vP: 'на Суматру и Калимантан', loc: 'на Суматре и Калимантане' },
  ...
  'saudi-arabia': { nom: 'Саудовская Аравия', acc: 'Саудовскую Аравию', prep: 'Саудовской Аравии', vP: 'в Саудовскую Аравию', loc: 'в Саудовской Аравии' },
  'oman': { nom: 'Оман', acc: 'Оман', prep: 'Омане', vP: 'в Оман', loc: 'в Омане' },
  'qatar': { nom: 'Катар', acc: 'Катар', prep: 'Катаре', vP: 'в Катар', loc: 'в Катаре' },
...
const DEST_VISUALS = {
  ...
  'saudi-arabia':     { emoji: '🏜️', g1: '#fde7d3', g2: '#f3c9a0' },
  'oman':             { emoji: '⛰️', g1: '#e7efe4', g2: '#c3d6bd' },
  'qatar':            { emoji: '🕌', g1: '#e8e4f3', g2: '#c9c0e4' },
