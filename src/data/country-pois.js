...
export const POIS = {
  'china': {
    ...
    pois: [
      ...
      { name: 'Шанхай', lat: 31.2304, lng: 121.4737, type: 'city', note: 'Набережная Бунд и небоскрёбы Пудуна', photo: 'poi/china/02-shankhay-vaytan.jpg', alt: 'Старые здания набережной Вайтань в Шанхае, вид с Пудуна' },
      ...
      { name: 'Чжанцзяцзе', lat: 29.1271, lng: 110.4791, type: 'nature', note: 'Скалы-столбы из «Аватара», парк в списке ЮНЕСКО', photo: 'poi/china/06-chzhantszyatsze-tyanmen.jpg', alt: 'Небесные ворота горы Тяньмэнь и лестница к ним у Чжанцзяцзе' },
  ...
  'hainan': {
    ...
    pois: [
      ...
      { name: 'Наньшань', lat: 18.2814, lng: 109.1989, type: 'culture', note: 'Буддийский парк со статуей Гуаньинь высотой 108 м', photo: 'poi/hainan/06-nanshan-khram.jpg', alt: 'Ворота храма Наньшань с красными фонарями' },
  ...
  'egypt': {
    ...
    pois: [
      { name: 'Каир и Гиза', lat: 29.9773, lng: 31.1325, type: 'culture', note: 'Пирамиды Гизы, Сфинкс и Египетский музей', photo: 'poi/egypt/01-kair-mechet-muhammeda-ali.jpg', alt: 'Мечеть Мухаммеда Али в Цитадели Каира' },
  ...
  'malaysia': {
    ...
    pois: [
      { name: 'Куала-Лумпур', lat: 3.1390, lng: 101.6869, type: 'city', note: 'Башни Петронас и пещеры Бату', photo: 'poi/malaysia/01-kuala-lumpur-sultan-abdul-samad.jpg', alt: 'Здание Султана Абдул-Самада в Куала-Лумпуре' },
      ...
      { name: 'Камеронское нагорье', lat: 4.4710, lng: 101.3760, type: 'nature', note: 'Чайные плантации и прохлада', photo: 'poi/malaysia/07-kameronskoe-nagorye-klubnika.jpg', alt: 'Теплица с клубникой в Камерон-Хайлендс' }
    ],
    sources: [{ name: 'OpenStreetMap', url: 'https://www.openstreetmap.org/' }]
  },
  ...
  'peru': {
    ...
    pois: [
      ...
      { name: 'Мачу-Пикчу', lat: -13.1631, lng: -72.5450, type: 'culture', note: 'Объект ЮНЕСКО, билеты покупают за полгода', photo: 'poi/peru/03-machu-pikchu-lamy.jpg', alt: 'Ламы у каменных стен Мачу-Пикчу' },
  ...
  'chile': {
    ...
    pois: [
      ...
      { name: 'Атакама (Сан-Педро)', lat: -22.9098, lng: -68.1996, type: 'nature', note: 'Самая сухая пустыня мира и гейзеры', photo: 'poi/chile/03-atakama-laguna-miskanti.jpg', alt: 'Лагуна Мискани у подножия вулкана Мисканти в Атакаме' },
  ...
  'bali': {
    ...
    pois: [
      ...
      { name: 'Чангу', lat: -8.6478, lng: 115.1385, type: 'beach', note: 'Сёрфинг и удалёнщики', photo: 'poi/bali/03-changu-plyazh.jpg', alt: 'Волны на тёмном песке пляжа Чангу' },
      ...
      { name: 'Мунду', lat: -8.2762, lng: 115.0383, type: 'nature', note: 'Север Бали, водопады', photo: 'poi/bali/07-mundu-vodopad.jpg', alt: 'Водопад в джунглях у Мунду' },
  ...
  'uae': {
    ...
    pois: [
      { name: 'Дубай', lat: 25.2048, lng: 55.2708, type: 'city', note: 'Бурдж-Халифа, Дубай Молл и остров Пальма', photo: 'poi/uae/01-dubay-al-fakhidi.jpg', alt: 'Дома с ветряными башнями в квартале Аль-Фахиди в Дубае' },
      { name: 'Абу-Даби', lat: 24.4539, lng: 54.3773, type: 'city', note: 'Мечеть шейха Зайда и Лувр Абу-Даби', photo: 'poi/uae/02-abu-dabi-luvr.jpg', alt: 'Белые залы у воды под куполом Лувра Абу-Даби' },
      ...
      { name: 'Фуджейра', lat: 25.1288, lng: 56.3265, type: 'beach', note: 'Восточный берег, дайвинг в Индийском океане', photo: 'poi/uae/06-fudzheyra-al-bidya.jpg', alt: 'Глиняная мечеть Аль-Бидья и сторожевая башня на холме' },
  ...
  'vietnam': {
    ...
    pois: [
      ...
      { name: 'Халонг', lat: 20.9101, lng: 107.1839, type: 'nature', note: 'Известняковые острова и круизы по бухте', photo: 'poi/vietnam/02-khalong-peshchera-sungshot.jpg', alt: 'Пещера Сунгшот на острове в бухте Халонг' },
  ...
  'armenia': {
    ...
    pois: [
      ...
      { name: 'Хор Вирап', lat: 39.8788, lng: 44.5783, type: 'culture', note: 'Древний монастырь с видом на Арарат', photo: 'poi/armenia/06-khor-virap-sverkhu.jpg', alt: 'Монастырь Хор Вирап за крепостной стеной среди полей' },
  ...
  'sri-lanka': {
    ...
    pois: [
      ...
      { name: 'Элла', lat: 6.8716, lng: 81.0463, type: 'nature', note: 'Девятиарочный мост и чайные плантации', photo: 'poi/sri-lanka/04-ella-malyy-pik-adama.jpg', alt: 'Зелёный хребет Малого пика Адама у Эллы' },
  ...
  'mexico': {
    ...
    pois: [
      ...
      { name: 'Чичен-Ица', lat: 20.6843, lng: -88.5678, type: 'culture', note: 'Пирамида Кукулькана, объект ЮНЕСКО', photo: 'poi/mexico/05-chichen-itsa-khram-voinov.jpg', alt: 'Храм воинов и ряды колонн в Чичен-Ице' },
  ...
  'cuba': {
    ...
    pois: [
      ...
      { name: 'Виньялес', lat: 22.6168, lng: -83.7060, type: 'nature', note: 'Долина с холмами-моготе и табачные плантации', photo: 'poi/cuba/04-vinyales-sushilnya-tabaka.jpg', alt: 'Сушильня табака под соломенной крышей в Виньялесе' },
  ...
  'italy-south': {
    ...
    pois: [
      ...
      { name: 'Амальфи', lat: 40.6346, lng: 14.6027, type: 'beach', note: 'Побережье из списка ЮНЕСКО и Позитано', photo: 'poi/italy-south/04-amalfi-villa-rufolo.jpg', alt: 'Вилла Руфоло в Равелло над Амальфитанским побережьем' },
  ...
  'spain': {
    ...
    pois: [
      ...
      { name: 'Севилья', lat: 37.3891, lng: -5.9845, type: 'culture', note: 'Алькасар, фламенко и Страстная неделя', photo: 'poi/spain/03-sevilya-khiralda.jpg', alt: 'Хиральда и собор Севильи вечером' },
  ...
  'turkey': {
    ...
    pois: [
      ...
      { name: 'Каппадокия', lat: 38.6431, lng: 34.8289, type: 'nature', note: 'Воздушные шары на рассвете', photo: 'poi/turkey/03-kappadokiya-skaly.jpg', alt: 'Туфовые скалы с пещерными жилищами в Каппадокии' },
  ...
  'thailand': {
    ...
    pois: [
      ...
      { name: 'Краби', lat: 8.0863, lng: 98.9063, type: 'beach', note: 'Известняковые скалы и Райли', photo: 'poi/thailand/04-krabi-khram-tigrovoy-peshchery.jpg', alt: 'Статуя Будды на вершине у храма Тигровой пещеры в Краби' },
