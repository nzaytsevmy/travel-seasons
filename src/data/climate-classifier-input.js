// Вход классификатора климата месяца (country-month-bucket.js) — и ТОЛЬКО его.
// Это прежняя ручная таблица норм 19 стран со станций, перенесённая сюда 05.09.2026,
// когда показ погоды на страницах перешёл на один источник (реанализ ERA5,
// src/data/country-monthly-weather.js). Классификатору её оставили нарочно: его
// порог «дождливых дней» настроен на станционные данные, а реанализ считает
// моросящие дни и завышает их число — Шри-Ланка в сухой сезон выходила «дождь».
// Файл умирает вместе с переделкой классификатора под все климаты (заявка #490);
// править числа здесь не нужно — они влияют только на класс месяца для сборов.
//
// Формат: months[0..11] = { temp: '<min>-<max>°C', rain: '<mm> / <дн>' }

export const CLASSIFIER_INPUT = {
  'bali': {
    city: 'Денпасар',
    months: [
  ...
  'vietnam': {
    city: 'Хошимин (юг); север и центр отличаются сильно — см. разбор по регионам',
    months: [
      { temp: '23-32°C', rain: '12 мм / 2 дн' },   // январь — сухой сезон на юге
      { temp: '23-33°C', rain: '8 мм / 1 дн' },
      { temp: '25-34°C', rain: '18 мм / 1 дн' },
      { temp: '26-34°C', rain: '57 мм / 4 дн' },
      { temp: '26-35°C', rain: '202 мм / 13 дн' }, // май — начало муссона
      { temp: '26-34°C', rain: '224 мм / 16 дн' },
      { temp: '25-33°C', rain: '231 мм / 19 дн' },
      { temp: '25-33°C', rain: '219 мм / 17 дн' },
      { temp: '25-33°C', rain: '273 мм / 18 дн' }, // сентябрь — пик дождей на юге
      { temp: '25-32°C', rain: '240 мм / 16 дн' },
      { temp: '25-32°C', rain: '128 мм / 9 дн' },
      { temp: '24-32°C', rain: '41 мм / 5 дн' },
    ],
    // Сверено 04.09.2026 по климатическим нормам 1991–2020, которые метеослужба
    // Вьетнама (VNMHA) публикует через World Weather Information Service ВМО.
    source: 'нормы 1991–2020 метеослужбы Вьетнама (VNMHA) через ВМО — Ho Chi Minh City',
  },
