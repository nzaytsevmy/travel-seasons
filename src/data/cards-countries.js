...
export const issuingBanks = {
  ...
  foreign: [
    ...
    { name: "ОАЭ — ADCB, Emirates NBD", note: "Только при наличии Emirates ID (ВНЖ). Без ВНЖ — невозможно." },
    { name: "Сербия — Banca Intesa, AIK Banka, OTP", note: "Личный визит, белый картон (регистрация адреса), при наличии ВНЖ — стандартная процедура." },
  ],
};
