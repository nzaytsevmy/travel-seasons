...
export const MONTHLY_WEATHER = {
  ...
  'egypt': {
    city: 'Хургада',
    months: [
      { temp: '11-22°C', rain: '2 мм / 0 дн' },   // январь — прохладные ночи
      { temp: '12-24°C', rain: '0 мм / 0 дн' },
      { temp: '15-26°C', rain: '6 мм / 0 дн' },
      { temp: '19-30°C', rain: '0 мм / 0 дн' },
      { temp: '23-34°C', rain: '5 мм / 0 дн' },
      { temp: '26-36°C', rain: '0 мм / 0 дн' },   // июнь — жара начинается
      { temp: '28-37°C', rain: '0 мм / 0 дн' },
      { temp: '28-38°C', rain: '1 мм / 0 дн' },   // август — пик жары
      { temp: '26-35°C', rain: '3 мм / 0 дн' },
      { temp: '22-32°C', rain: '5 мм / 0 дн' },
      { temp: '18-28°C', rain: '0 мм / 0 дн' },
      { temp: '13-24°C', rain: '6 мм / 0 дн' },
    ],
    source: 'climatestotravel.com (нормы 1991–2020) — Hurghada',
  },
  'south-korea': {
    city: 'Сеул',
    months: [
      { temp: '-6-2°C', rain: '15 мм / 6 дн' },   // январь — мороз
      { temp: '-4-5°C', rain: '30 мм / 6 дн' },
      { temp: '1-11°C', rain: '35 мм / 7 дн' },
      { temp: '7-18°C', rain: '75 мм / 8 дн' },
      { temp: '13-24°C', rain: '105 мм / 9 дн' },
      { temp: '18-28°C', rain: '130 мм / 10 дн' },
      { temp: '22-29°C', rain: '415 мм / 16 дн' }, // июль — муссонный пик
      { temp: '23-30°C', rain: '350 мм / 15 дн' },
      { temp: '17-26°C', rain: '140 мм / 9 дн' },
      { temp: '10-20°C', rain: '50 мм / 6 дн' },   // октябрь — золотая осень
      { temp: '3-12°C', rain: '50 мм / 9 дн' },
      { temp: '-4-4°C', rain: '25 мм / 8 дн' },
    ],
    source: 'climatestotravel.com (нормы 1991–2020) — Seoul',
  },
  'india-goa': {
    city: 'Даболим (побережье Гоа)',
    months: [
      { temp: '20-32°C', rain: '0 мм / 0 дн' },    // январь — сухо и солнечно
      { temp: '21-32°C', rain: '0 мм / 0 дн' },
      { temp: '23-32°C', rain: '1 мм / 0 дн' },
      { temp: '26-33°C', rain: '12 мм / 1 дн' },
      { temp: '26-33°C', rain: '115 мм / 4 дн' },
      { temp: '25-30°C', rain: '870 мм / 22 дн' }, // июнь — муссон обрушивается
      { temp: '24-29°C', rain: '995 мм / 27 дн' }, // июль — пик муссона
      { temp: '24-29°C', rain: '515 мм / 13 дн' },
      { temp: '24-30°C', rain: '250 мм / 14 дн' },
      { temp: '24-32°C', rain: '125 мм / 6 дн' },  // октябрь — муссон уходит
      { temp: '22-33°C', rain: '30 мм / 3 дн' },
      { temp: '21-32°C', rain: '15 мм / 0 дн' },
    ],
    source: 'climatestotravel.com (нормы 1991–2020) — Goa/Dabolim',
  },
  'montenegro': {
    city: 'Улцинь (южное побережье)',
    months: [
      { temp: '4-12°C', rain: '140 мм / 9 дн' },   // январь — мягко, но дождливо
      { temp: '4-13°C', rain: '125 мм / 10 дн' },
      { temp: '7-16°C', rain: '125 мм / 9 дн' },
      { temp: '10-19°C', rain: '105 мм / 9 дн' },
      { temp: '14-24°C', rain: '80 мм / 7 дн' },
      { temp: '18-28°C', rain: '60 мм / 4 дн' },
      { temp: '20-31°C', rain: '30 мм / 2 дн' },   // июль — сухой пик сезона
      { temp: '20-31°C', rain: '40 мм / 3 дн' },
      { temp: '17-27°C', rain: '110 мм / 6 дн' },
      { temp: '13-22°C', rain: '145 мм / 8 дн' },
      { temp: '9-17°C', rain: '165 мм / 10 дн' },  // ноябрь — самый мокрый
      { temp: '5-13°C', rain: '165 мм / 11 дн' },
    ],
    source: 'climatestotravel.com (нормы 1991–2020) — Ulcinj',
  },
};
