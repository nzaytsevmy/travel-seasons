...
1. **БРЕНДБУК (дизайн)** → [`BRANDBOOK.md`](./BRANDBOOK.md) — Swiss/International Typographic, выведен
   из главной v1. Один гротеск Archivo; палитра (`--gold #8e6618` — единственный акцент, нижняя граница
...
11. **DEFINITION OF DONE** → измерять, не угадывать; «build ≠ работает»; визуал-гейт зелёный ДО пуша;
    Chain-of-Verification (написать опровергающие проверки и прогнать независимо). [[feedback_definition_of_done]] · [[feedback_visual_check]].
